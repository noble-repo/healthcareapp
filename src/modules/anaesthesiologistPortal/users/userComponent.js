    ...
    <Main>
      <Wrapper>
        <div>
          ...
          />
          <Searchinput placeholder="Search User" type="text" id="searchText" onChange={props.onSearch} />
        </div>
              ...
              <Card className={classes.root} >
                <CardActionArea>
                  <CardMedia
                    ...
                    image={props.user.picture || '/images/download.jpg'}
                  ...
                  <CardContent>
                    ...
                    <Typography
                      ...
                      component="p"
                    >
                      {props.user.role /*=== Auth0RoleNameConstants.ADMIN ? 'Admin' : ''*/}
                    </Typography>
