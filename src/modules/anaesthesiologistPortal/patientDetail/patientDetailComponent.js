...
import ConsolidatedSurveyResult from "../../consolidatedSurveyResult";
                        ...
                        <div className={classes.coloumn}>
                            ...
                            <div className={classes.tabRoot}>
                                ...
                                <TabPanel className={classes.panel} value={value} index={0}>
                                    ...
                                    <PatientGeneralInformation selectedSurgery={props?.state?.selectedSurgery || ''}/>}
                                </TabPanel>

                                <TabPanel className="w-75" value={value} index={1}>
                                    {value === 1 && props?.state?.selectedSurgery?.patient?.surveyId &&
