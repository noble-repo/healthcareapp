        ...
        <div>
            <Row className={classes.row}>
                ...
                <Row className={classes.divfixing}>
                    ...
                    <div>
                        <Button onClick={props.editDialog}><span className={classes.txt}>Add Surgery </span></Button>
                    </div>

                    <MainButton onClick={props.handleDialog}>New Patient</MainButton>
                </Row>
            </Row>
                ...
                {props.state.patientList.length > 0 && props.state.patientList.map((data) => (
                    <tr>
                        ...
                        <td className={classes.td}
                            onClick={() => history.push(`/surgeon/details-patients/${data.surgeryId}`)}
